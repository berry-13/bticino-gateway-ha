...
class LegrandSmartherFlowHandler(
    ...
    def __init__(self):
        ...
        self.flow_impl: Optional[config_entry_oauth2_flow.AbstractOAuth2Implementation] = None
        ...
        try:
            ...
            for plant in self._plants:
                try:
                    ...
                    _LOGGER.warning("Error fetching topology for plant %s: %s", plant["id"], err)
                    continue
        ...
        if user_input is not None:
            ...
            for module_id in selected_modules:
                ...
                if module:
                    ...
                    existing_entry = await self.async_set_unique_id(f"{DOMAIN}_{module_id}")
                    if existing_entry:
